...
Building of Steiner systems and projective planes we can delve deeper into their relation to Dobble.
...
We are then left with a grid of $56$ lines and we can see that there are actually $8$ different systems of $7$ parallel lines. Each collection of parallel lines converges at infinity at some point,\cite{spencer1999}
